...
impl LinkingStats {
    pub fn print(&self) {
        println!("🔗 Entity Linking Statistics:");
        println!("   Entities processed: {}", self.entities_processed);
        println!("   Clusters created: {}", self.clusters_created);
        println!("   Exact matches: {}", self.exact_matches);
        println!("   Fuzzy matches: {}", self.fuzzy_matches);
        println!("   Semantic matches: {}", self.semantic_matches);
        println!("   LMCD clusters: {}", self.lmcd_clusters);
        println!("   Disambiguation conflicts: {}", self.disambiguation_conflicts);
        println!("   Linking accuracy: {:.1}%", self.linking_accuracy * 100.0);
    }
}
...
impl CrossDocumentEntityLinker {
    ...
    pub async fn link_entities(&mut self, document_entities: HashMap<String, Vec<Entity>>) -> Result<Vec<EntityCluster>> {
        println!("🔗 Starting cross-document entity linking...");
        println!("   Documents: {}", document_entities.len());
        ...
        println!("   Total entities to link: {}", all_entities.len());
        ...
        println!("   ✅ Linking complete: {} clusters created", self.clusters.len());
    ...
    async fn fuzzy_match_linking(&mut self, entities: Vec<CrossDocumentEntity>, threshold: f32) -> Result<()> {
        println!("   🔍 Fuzzy matching with threshold: {threshold:.2}");
    ...
    async fn semantic_similarity_linking(&mut self, entities: Vec<CrossDocumentEntity>, threshold: f32) -> Result<()> {
        println!("   🧠 Semantic similarity linking with threshold: {threshold:.2}");
    ...
    async fn lmcd_clustering(&mut self, entities: Vec<CrossDocumentEntity>, confidence_threshold: f32) -> Result<()> {
        println!("   🤖 LMCD clustering with confidence threshold: {confidence_threshold:.2}");
    ...
    async fn hybrid_linking(&mut self, entities: Vec<CrossDocumentEntity>) -> Result<()> {
        println!("   🔄 Hybrid linking strategy");
