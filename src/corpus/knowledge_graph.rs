...
impl GraphStats {
    pub fn print(&self) {
        println!("📈 Corpus Knowledge Graph Statistics:");
        println!("   Total entities: {}", self.total_entities);
        println!("   Total relations: {}", self.total_relations);
        println!("   Cross-document entities: {}", self.cross_document_entities);
        println!("   Single-document entities: {}", self.single_document_entities);
        println!("   Avg connections per entity: {:.1}", self.avg_entity_connections);
        println!("   Graph density: {:.3}", self.graph_density);
        println!("   Largest connected component: {}", self.largest_component_size);
    }
}
...
impl CorpusKnowledgeGraph {
    ...
    pub async fn build_from_clusters(
        ...
        println!("🔨 Building corpus-level knowledge graph...");
        println!("   Entity clusters: {}", clusters.len());
        ...
        println!("   ✅ Knowledge graph built: {} entities, {} relations",
            self.global_entities.len(), self.global_relations.len());
    ...
    async fn identify_cross_document_relations(
        ...
        println!("   🔍 Identifying cross-document relations...");
        ...
        println!("   ✅ Cross-document relations identified: {}", self.global_relations.len());
        Ok(())
    }
    ...
    pub async fn integrate_new_document(&mut self, _document_metadata: &crate::corpus::document_manager::DocumentMetadata) -> Result<()> {
        ...
        println!("   📄 Integrating new document into knowledge graph");
        Ok(())
    }

    /// Query the knowledge graph
    pub async fn query(&self, query: &str) -> Result<Vec<GlobalEntity>> {
        println!("🔍 Querying corpus knowledge graph: '{query}'");
    ...
    pub async fn export(&self, output_path: &Path) -> Result<()> {
        println!("💾 Exporting knowledge graph to: {}", output_path.display());
        ...
        println!("   ✅ Knowledge graph exported successfully");
